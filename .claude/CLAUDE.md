...
- **Netlify URLs are case-sensitive, Windows is not**: match file-name case exactly in `src`/`href`.
...
4. **Check:** automated checks + `visual-qa` at 1366/1070/954/768/682/681/535/375/320 and one regression page, before committing.
5. **Act / Review:** add a lesson to `.claude/notes/lessons.md`; update `.claude/notes/todo.md`; report with evidence.
